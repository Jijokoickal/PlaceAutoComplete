...
import com.example.android.common.custom.CustomAutoCompleteTextView;
import com.example.android.common.custom.DrawableClickListener;
...
public class MainActivity extends SampleActivityBase
    ...
    private final DrawableClickListener onDrawableClickListener = new DrawableClickListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutocompleteView = (CustomAutoCompleteTextView)
                findViewById(R.id.autocomplete_places);

        // Register a listener that receives callbacks when a suggestion has been selected
        mAutocompleteView.setOnItemClickListener(mAutocompleteClickListener);
        mAutocompleteView.setDrawableClickListener(onDrawableClickListener);
